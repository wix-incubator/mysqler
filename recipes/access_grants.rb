...
begin
  databag_name = node['mysqler']["users_databag_name"] rescue ""
  if databag_name.length >0 and node['mysqler']['users_databag_item']
    ...
    Chef::Log.info("Not processing application specific users. node['mysqler']['users_databag_name'] or node['mysqler']['users_databag_item'] not set")
  end
